...
namespace Discord
{
    ...
    public partial class Discord : IDisposable
    {
        ...
        public Discord(Int64 clientId, UInt64 flags)
        {
            ...
            Log.Info("Discord.Discord() MethodsPtr before: " + MethodsPtr);
            var result = DiscordCreate(2, ref createParams, out MethodsPtr);
            Log.Info("Discord.Discord() MethodsPtr after: " + MethodsPtr);
            if (result != Result.Ok)
            {
                Dispose();
    ...
    public partial class ActivityManager
    {
        ...
        private FFIMethods.ClearActivityCallback MyClearActivityCallback = ClearActivityCallbackImpl;
        ...
        {
            GCHandle wrapped = GCHandle.Alloc(callback);
            Methods.ClearActivity(MethodsPtr, GCHandle.ToIntPtr(wrapped), MyClearActivityCallback);
        }
